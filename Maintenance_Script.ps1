...
Invoke-Command -Computer $updatelist -ScriptBlock {Set-ExecutionPolicy Unrestricted; Import-Module PSWindowsUpdate; #Add-WUServiceManager -ServiceID 7971f918-a847-4430-9279-4a52d1efe18d; Get-WUInstall -AcceptAll -Install –MicrosoftUpdate -Verbose -IgnoreReboot} 
